...
// ══════════════════════════════════════════════════════════
{
  ...
  const strengths = [
    { h: '仕入れコスト = ほぼゼロ', b: '廃棄物回収網から家電を調達。競合が真似できない原価構造で業界最安水準を実現' },
...
// ══════════════════════════════════════════════════════════
{
  ...
  const channels = [
    { n: 1, pri: '即効', col: GREEN, bg: LTGRN,
      title: '既存顧客経由（廃棄物回収先250社）',
      why: '既存250社の信頼関係を直接活用。受注コストほぼゼロ',
      how: ['既存法人担当者へDM・TELで紹介依頼',
            '担当者のお子様・知人の新入生にアプローチ',
            '成約時に紹介者へ謝礼（商品券・割引等）'],
      timing: '今すぐ開始（全顧客リストへ展開）' },
    { n: 2, pri: '重点', col: CORAL, bg: OFFWH,
      title: '留学生比率高・中小規模大学生協',
      why: '城西大学等競合未提携の中小校。留学生はニーズが高い',
      how: ['競合未提携の中小大学をリストアップ',
            '生協・学生センターへ提案（KB 2千円/件）',
            '在日留学生コミュニティへの口コミも活用'],
      timing: '10〜12月仕込み、3〜4月獲得' },
    { n: 3, pri: '補完', col: AMBER, bg: LTAM,
      title: 'チラシ設置 + キックバック',
      why: '入居タイミングで接触。KB設計で紹介元の動機を確保',
      how: ['仲介・入寮施設にチラシ設置（KB 2千円/件）',
            '外国人支援窓口・留学生ハウスにも配布',
            '管理会社にQRコード付きカードを設置'],
      timing: '通年（1〜3月を重点化）' },
  ];
