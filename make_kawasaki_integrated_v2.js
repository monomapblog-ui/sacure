...
// ═══════════════════════════════════════════════════════════
{
  ...
  // 右側: 3つのキー数字
  const nums = [
    { val: '200台以上', sub: 'センサー搭載対象トラック', col: CORAL },
    { val: '250社超',  sub: '廃棄物量データ収集施設',           col: GREEN },
...
// ═══════════════════════════════════════════════════════════
{
  ...
  const pillars = [
    ...
    { kanji: '循', col: GREEN,
      title: '廃棄物収集許可業者として独占取得',
      body: '廃棄物収集許可を持つ業者のみが施設内のデータを合法的に記録可能。250社超の施設から廃棄物量データを独占的に取得できます。' },
    { kanji: '信', col: TEAL,
      title: '行政・企業との協業実績',
