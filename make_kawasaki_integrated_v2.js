...
// ═══════════════════════════════════════════════════════════
{
  ...
  txt(s, '▶ 上記はすべて川崎市重点施策「未来の市民の足を守る交通環境の形成」「データを活用した健康づくり」と直接連動しています。',
    0.54, 5.38, 9.06, 0.22,
    { fontSize: 9, color: MUTED });

  s.addNotes('3つの課題：①市道約2,400kmのカバー率限界（川崎市固有数値）、②道路インフラ長寿命化計画が掲げる予防保全への転換、③環境施策・廃棄物管理のデータ不足。サキュレの2事業で解決を提案。川崎市重点施策との連動を明示。');
}
